/****************************************************************************
*
*			Функции класса IncreaseLeftElemCondition
*
****************************************************************************/
...
*
*	Description:	Сравнение двух IncreaseLeftElemCondition на включение (x < y).
*	Parameters:	IncreaseLeftElemCondition& second - правая часть выражения
*	Returns:		1 если < и second - это IncreaseLeftElemCondition
*				-1 если > и second - это IncreaseLeftElemCondition
*				0 иначе (по сути, если параметры отличаются не более, чем на 0.01 или если second - это не IncreaseLeftElemCondition)
*	Throws:		-
*	Author:		dk
*	History:
*
...
double IncreaseLeftElemCondition::operator< (const ElemCondition& second) const{
	// пытаемся получить y типа IncreaseLeftElemCondition* из second типа el_axiom
	const IncreaseLeftElemCondition* y = dynamic_cast<const IncreaseLeftElemCondition*> (&second);
  
	// если y != NULL, т.н. second действительно имело тип IncreaseLeftElemCondition&, то тогда что-то проверяем
