...
*				Integral
*
*	Description:	Элементарное условие - численный интеграл в заданной окрестности размечаемой точки находится в заданных пределах
*	Author:		dk
*	History:
*
****************************************************************************/

#ifndef __AXIOMS_LIB_EL_Integral_HXX
#define __AXIOMS_LIB_EL_Integral_HXX

#include "ElemCondition.h"

namespace AxiomLib { 

class Integral : public ElemCondition {
...
#endif /* __AXIOMS_LIB_EL_Integral_HXX */
