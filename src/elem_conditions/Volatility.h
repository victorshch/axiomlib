...
#ifndef __AXIOMS_LIB_EL_Volatility_HXX
#define __AXIOMS_LIB_EL_Volatility_HXX

#include "ElemCondition.h"

namespace AxiomLib { 

class Volatility : public ElemCondition {
  private:
  ...
  public:
	...
	Volatility * clone() const { return new Volatility(*this); }	
...
#endif /* __AXIOMS_LIB_EL_Volatility_HXX */
