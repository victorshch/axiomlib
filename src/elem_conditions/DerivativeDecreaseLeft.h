...
*
*	Description:	Элементарное условие убывания слева
*	Author:		dk
*	History:
*
****************************************************************************/

#ifndef __AXIOMS_LIB_EL_DerivativeDecreaseLeft_HXX
#define __AXIOMS_LIB_EL_DerivativeDecreaseLeft_HXX
...
class DerivativeDecreaseLeft : public ElemCondition {
  ...
  public:
	...
	DerivativeDecreaseLeft* clone() const { return new DerivativeDecreaseLeft(*this); }
...
#endif /* __AXIOMS_LIB_EL_DerivativeDecreaseLeft_HXX */
