...
*
*	Description:	Элементарное условие убывания справа в заданном угле
*	Author:		dk
*	History:
*
****************************************************************************/

#ifndef __AXIOMS_LIB_EL_DecreaseRightElemCondition_HXX
#define __AXIOMS_LIB_EL_DecreaseRightElemCondition_HXX

#include "ElemCondition.h"

namespace AxiomLib { 

class DecreaseRightElemCondition : public ElemCondition {
  ...
  public:
	...
	// Пустой конструктор
	DecreaseRightElemCondition(void);
	...
	DecreaseRightElemCondition* clone() const { return new DecreaseRightElemCondition(*this); }
...
#endif /* __AXIOMS_LIB_EL_DecreaseRightElemCondition_HXX */
