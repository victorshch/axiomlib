...
*
*	Description:	Элементарное условие возрастания слева в заданном узле
*	Author:		dk
*	History:
*
****************************************************************************/

#ifndef __AXIOMS_LIB_EL_IncreaseLeftElemCondition_HXX
#define __AXIOMS_LIB_EL_IncreaseLeftElemCondition_HXX

#include "ElemCondition.h"

namespace AxiomLib { 

class IncreaseLeftElemCondition : public ElemCondition {
  ...
  public:
	...
	// Пустой конструктор
	IncreaseLeftElemCondition(void);
	...
	IncreaseLeftElemCondition* clone() const { return new IncreaseLeftElemCondition(*this); }
...
#endif /* __AXIOMS_LIB_EL_IncreaseLeftElemCondition_HXX */
