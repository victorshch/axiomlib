...
*
*	Description:	Элементарное условие возрастания справа
*	Author:		dk
*	History:
*
****************************************************************************/

#ifndef __AXIOMS_LIB_EL_DerivativeIncreaseRight_HXX
#define __AXIOMS_LIB_EL_DerivativeIncreaseRight_HXX

#include "ElemCondition.h"

namespace AxiomLib { 

class DerivativeIncreaseRight : public ElemCondition {
  ...
  public:
	...
	DerivativeIncreaseRight* clone() const { return new DerivativeIncreaseRight(*this); }
...
#endif /* __AXIOMS_LIB_EL_DerivativeIncreaseRight_HXX */
