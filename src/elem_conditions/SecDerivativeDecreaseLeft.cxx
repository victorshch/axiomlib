/****************************************************************************
*
*			Функции класса SecDerivativeDecreaseLeft
*
****************************************************************************/
...
*
*	Description:	Сравнение двух SecDerivativeDecreaseLeft на включение (x < y).
*	Parameters:	SecDerivativeDecreaseLeft& second - правая часть выражения
*	Returns:		1 если < и second - это SecDerivativeDecreaseLeft
*				-1 если > и second - это SecDerivativeDecreaseLeft
*				0 иначе (по сути, если параметры отличаются не более, чем на 0.01 или если second - это не SecDerivativeDecreaseLeft)
*	Throws:		-
*	Author:		dk
*	History:
*
...
double SecDerivativeDecreaseLeft::operator< (const ElemCondition& second) const {
	// пытаемся получить y типа SecDerivativeDecreaseLeft* из second типа el_axiom
	const SecDerivativeDecreaseLeft* y = dynamic_cast<const SecDerivativeDecreaseLeft*> (&second);
  
	// если y != NULL, т.н. second действительно имело тип SecDerivativeDecreaseLeft&, то тогда что-то проверяем
