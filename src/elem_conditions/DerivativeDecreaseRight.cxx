/****************************************************************************
*
*			Функции класса DerivativeDecreaseRight
*
****************************************************************************/
...
*
*	Description:	Сравнение двух DerivativeDecreaseRight на включение (x < y).
*	Parameters:	DerivativeDecreaseRight& second - правая часть выражения
*	Returns:		1 если < и second - это DerivativeDecreaseRight
*				-1 если > и second - это DerivativeDecreaseRight
*				0 иначе (по сути, если параметры отличаются не более, чем на 0.01 или если second - это не DerivativeDecreaseRight)
*	Throws:		-
*	Author:		dk
*	History:
*
...
double DerivativeDecreaseRight::operator< (const ElemCondition& second) const{
	// пытаемся получить y типа DerivativeDecreaseRight* из second типа el_axiom
	const DerivativeDecreaseRight* y = dynamic_cast<const DerivativeDecreaseRight*> (&second);
  
	// если y != NULL, т.н. second действительно имело тип DerivativeDecreaseRight&, то тогда что-то проверяем
