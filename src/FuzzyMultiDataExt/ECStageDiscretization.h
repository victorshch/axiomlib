...
public:
	DiscretizationConfiguration(const FuzzyDataSet *fuzzyDataSet, int dimensionIndex, int numOfLevels, int windowSize);
...
private:
	...
	boost::accumulators::accumulator_set<double,
		boost::accumulators::features<boost::accumulators::tag::rolling_mean> > rollingMean;

	boost::accumulators::accumulator_set<double,
		boost::accumulators::features<boost::accumulators::tag::mean, boost::accumulators::tag::variance> > stats;
