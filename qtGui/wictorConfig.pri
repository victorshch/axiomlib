# Файл, в котором задаются параметры сборки qtGui
...
debug {
        AXIOMLIB_LIB = D:\My_documents\Workspace\Axiomlib_working_copy\AxiomLib-build-desktop\debug\AxiomLib.lib
        QWT_LIB = D:\lib\qwt-5.2.1\lib\qwtd.lib
        MPICH_LIB = "C:\Program Files (x86)\MPICH2\lib\mpi.lib"
} release {
        AXIOMLIB_LIB = D:\My_documents\Workspace\Axiomlib_working_copy\AxiomLib-build-desktop\release\AxiomLib.lib
...
linux-icc-64|linux-icc {
        ...
        AXIOMLIB_LIB = /home/wictor/Projects/AxiomLib-build-desktop/release/libAxiomLib.a
}
